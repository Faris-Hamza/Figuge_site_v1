      ...
      <div class="Information">
        <h1 class="sec2_title">Contactez Nous</h1>
              <div class="grid-1 temp">
                  <a href="#"><input style="width: 100%;" type="text" disabled placeholder="FB : {{$info->fb}}"></a>
                  <a href="#"><input style="width: 100%;" type="text" disabled placeholder="Téléphone: {{$info->whatsapp}}"></a>
                  <a href="#"><input style="width: 100%;" type="text" disabled placeholder="Email : {{$info->email}}"></a>
              </div>
      </div>
