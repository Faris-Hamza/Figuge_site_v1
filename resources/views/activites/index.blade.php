                  ...
                  @foreach ($activite as $item)
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{route('activite/edit',$item->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Modifie
                        </a>
                      </td>
                      <td class="align-middle">
                        <a href="{{route('activite/destroy',$item->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Supprimer
                        </a>
                      </td>
                    </tr>
    ...
    <div class="row">
        ...
        <div class="col justify-content-center">
            <div class="card my-3 " style="width: 18rem;">
                <img src="{{asset($item->Media->firstWhere('types', 'photo')->URL)}}" class="card-img-top" alt="...">
                <div class="card-body">
