...
@section('Content')
    ...
    @endif
        <form action="{{route('equipes/update',$equipes->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control"name="nom" placeholder="entrer votre nom"  value="{{$equipes->nom}}">
                </div>
                <div class="mb-3">
                <label for="statu" class="form-label">Statu</label>
                <input type="text" class="form-control" name="statu" placeholder="entrer votre statu " value="{{$equipes->statu}}" >
                </div>
                <div class="mb-3">
